                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('race') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="race" class="form-control" name="race" value="{{ old('country') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('height') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="height" type="number" class="form-control" name="height" value="{{ old('height') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('illness') ? ' has-error' : '' }}">
                            <label for="illness" class="col-md-4 control-label">Physical or mental illness:</label>
                            <div class="col-md-6">
                                <input id="illness" type="text" class="form-control" name="illness" value="{{ old('illness') }}">
